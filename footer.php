...
<footer class="site-footer block" id="site-footer">
	...
	<div class="site-footer__primary block--padded-md">
		<div class="<?php echo esc_attr($container); ?>">
			<div class="row g-5">
				<div class="site-footer__logo col-12 col-lg-6 col-xl-4">
					<?php dynamic_sidebar('footer-col-1'); ?>
				</div>
				<div class="site-footer__menu column-menu col-12 col-lg-6 col-xl">
					<?php dynamic_sidebar('footer-col-2'); ?>
				</div>
				<div class="site-footer__menu col-12 col-lg-6 col-xl-2">
