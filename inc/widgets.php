...
if (!function_exists('understrap_widgets_init')) {
	...
	function understrap_widgets_init()
	{
		register_sidebar(
			array(
				'name' => __('Footer Disclaimer', 'understrap'),
				'id' => 'footer-disclaimer',
				'description' => __('Disclaimer footer widgets', 'understrap'),
				'before_widget' => '<div id="%1$s" class="site-footer__disclaimer-widget col-md-12 dynamic-classes">',
		...
		for ($i = 1; $i <= $footer_cols; $i++) {
			register_sidebar(array(
				...
				'id' => 'footer-col-' . $i,
				'description' => __('Widgets in this area will be shown in the footer.', 'understrap-child'),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget' => '</div>',
				'before_title' => '<p class="widget-title footer-heading">',
				'after_title' => '</p>',
			));
		}
